...
// 在run方法中循环取出requestQueue（PriorityBlokingQueue，take的时候是阻塞的）里面的request处理——即新建mapedFile
    ...
    public boolean load() {
        ...
        try {
            ...
            log.debug("开始调用 load Commit Log load Consume Queue");
            // load Commit Log
...
//                    }
    ...
    private void addScheduleTask() {
        ...
        this.scheduledExecutorService.scheduleAtFixedRate(new Runnable() {
            ...
            public void run() {
                ...
                log.debug(("checkSelf 线程池启动 10min"));
    ...
    private void cleanFilesPeriodically() {
        log.debug("线程池每隔 10000 ms cleanFilesPeriodically 清理资源");
